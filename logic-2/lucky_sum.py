...
def lucky_sum(a, b, c):
  if a == 13: return 0 # Returns 0 if a is 13
  if b == 13: return a # Returns a if b is 13
  if c == 13: return a + b # Returns a and b if c is 13
  return a + b + c # If none are 13, return full sum
