...
def caught_speeding(speed, is_birthday):
  if (speed <= 66 and is_birthday) or speed <= 61: return 0 # Returns 0 if there is no ticket
  if (speed <= 85 and is_birthday) or speed <= 81: return 1 # Returns 1 if there is a small ticket
  return 2 # Returns 2 if there is a big ticket
