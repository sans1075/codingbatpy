...
def date_fashion(you, date):
  if you < 3 or date < 3: return 0 # Returns no if either of you are unstylish
  if you > 7 or date > 7: return 2 # Returns yes if either of you are stylish
  return 1 # Returns maybe if neither parameters are met
